...
export const FeatureCard = ({title, image, description}: ICard) => {
    return (
        <div className="">
            ...
            <Image src={image} alt={title}  width={1000} height={500} className="w-full"/>
            <svg
            className="absolute right-0 bottom-0 cursor-pointer  transition animate-spin hover:animate-none"
          ...
          >
            ...
            <h3 className="title text-[#F3F3F4] font-[500] text-[22px] mt-7 mb-5 flex items-start">{title}</h3>
